...
//           className="w-full text-left text-mainMenu  font-medium appearance-none pl-[0.5rem] pr-[0.5rem] focus:outline-none cursor-pointer bg-transparent  duration-300 hover:text-sky-600 text-black"
//         >
